...
void test_to_array_suite()
{
  ...
  key_t entries[] = {10, 5, 8, 34, 67, 23, 156, 24, 2, 12, 27, 36, 990, 25};
  const size_t n = sizeof(entries) / sizeof(entries[0]);
...
{
  const key_t arr[] = {10, 5, 8, 34, 67, 23, 156, 24, 2, 12, 27, 36, 990, 25};
...
int main(void)
{
  ...
  // key_t arr[] = { 20, 9, 50, 7, 13, 40, 60, 12, 15, 70, 17 };
  // const size_t n = sizeof(arr) / sizeof(arr[0]);
  // insert_arr(t, arr, n);
}
